    ...
    html.Section(className="context",children=[
        ...
        html.Article(className="context__row",children=[
            html.Div(className="context__col",children=[
                html.Img(src="https://raw.githubusercontent.com/JoseCaliz/ds4a_project_dash/master/Des_page/img/img1t.png")
            ]),
            html.Div(className="context__col",children=[
                html.P(children=[
        ...
        html.Article(className="context__row",children=[
            ...
            html.Div(className="context__col",children=[
                html.Img(src="https://raw.githubusercontent.com/JoseCaliz/ds4a_project_dash/master/Des_page/img/img2t.png")
            ])
        ]),

        html.Article(className="context__row",children=[
            html.Div(className="context__col",children=[
                 html.Img(src="https://raw.githubusercontent.com/JoseCaliz/ds4a_project_dash/master/Des_page/img/img3t.png")
            ]),
            html.Div(className="context__col",children=[
        ...
        html.Article(className="context__row",children=[
            ...
            html.Div(className="context__col",children=[
                html.Img(src="https://raw.githubusercontent.com/JoseCaliz/ds4a_project_dash/master/Des_page/img/img4t.png")
            ])
        ]),
        ...
        html.Article(className="context__row",children=[
            html.Div(className="context__col",children=[
                html.Img(src="https://raw.githubusercontent.com/JoseCaliz/ds4a_project_dash/master/Des_page/img/img5t.png")
            ]),
            html.Div(className="context__col",children=[
                html.P(children=[
        ...
        html.Article(className="context__row",children=[
            ...
            html.Div(className="context__col",children=[
                html.Img(src="https://raw.githubusercontent.com/JoseCaliz/ds4a_project_dash/master/Des_page/img/img6t.png")
            ])
        ]),      
    ])
])
